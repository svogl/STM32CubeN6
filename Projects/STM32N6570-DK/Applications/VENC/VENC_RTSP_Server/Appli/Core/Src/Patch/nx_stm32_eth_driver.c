...
void HAL_ETH_RxAllocateCallback(uint8_t ** buff)
{
  ...
  else
  {
    ...
    *buff = NULL;
    printf("HAL_ETH_RxAllocateCallback : Rx Buffer Pool is exhausted - incoming packet lost !!!\n");
    printf("You may have to increase NX_PACKET_POOL_SIZE/NX_APP_MEM_POOL_SIZE\n");
  }
}
