...
waitType "1" "Select application to sign and flash (1=ENC_SDCard_ThreadX)> " "" "1"
APP_CHOICE="$val_waitType"
FSBL_PATH="../STM32CubeIDE/FSBL/Debug/VENC_SDCard_ThreadX_FSBL.bin"

case "$APP_CHOICE" in
	1)
		APP_NAME="VENC_SDCard_ThreadX"
		BIN_PATH="../STM32CubeIDE/Appli/Debug/VENC_SDCard_ThreadX_Appli.bin"
		;;
	*)
